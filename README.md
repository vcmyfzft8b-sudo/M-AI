...
1. Create recurring Stripe prices for weekly, monthly, and yearly plans, plus the `MEMO50` and `DAVID50` promotion codes.
...
- `npm run stripe:setup` bootstrap Stripe product, prices, `MEMO50` and `DAVID50` promotion codes, portal, and webhook
