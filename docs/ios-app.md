...
- Actual synthetic password login, AI-processing consent and the first onboarding screens passed in the iPhone simulator. The complete authenticated study workflow and purchase lifecycle remain pending.
