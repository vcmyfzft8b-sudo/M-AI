...
The red-cap block character has jacket and backpack details, fitted hands and sneakers, knee articulation, and a coordinated walking animation. The camera remains third person. Walking is 7.37 metres/second and running is 12.21, with Shift held. The movement hint disappears after the first movement. The minimap pins distant memories to its rim; the large map offers selectable numbered locations without teleporting. Both maps show collected memories and the player's camera direction.
