...
Rukovalac tvojim ličnim podacima je pružalac usluge Memo AI, dostupne na memoai.eu.
...
- agregirani podaci o posetama stranicama
...
- agregirana statistika korišćenja iz koje nije moguće prepoznati pojedinca
...
- **Vercel** — hosting aplikacije i agregirana statistika poseta
...
- **neophodne kolačiće i lokalno skladištenje** — za prijavu, održavanje sesije, bezbednost i osnovna podešavanja. Oni su potrebni za rad usluge i nije ih moguće isključiti
- **statistiku poseta** — agregirana i nelična merenja poseta stranicama putem Vercel Analyticsa

Oglašivačke kolačiće i praćenje između sajtova ne koristimo. Ako u budućnosti uvedemo neobavezne kolačiće, za njih ćemo zatražiti tvoj pristanak.
...
- **zahtev u roku od 5 dana od uplate** — vraćamo 50 % uplaćenog iznosa
- **zahtev nakon 5 dana od uplate** — nema povraćaja
...
Važi za svaku pojedinačnu uplatu, uključujući automatsko produženje. Rok od 5 dana za svaku se uplatu računa iznova, od datuma zaduženja.

## 3. Delimičan povraćaj u roku od 5 dana

Ako u roku od **5 kalendarskih dana od dana zaduženja** pošalješ zahtev za povraćaj, vraćamo ti **50 % uplaćenog iznosa** za taj period.

- rok počinje da teče na dan kada je uplata obračunata
- računa se datum kada tvoj zahtev stigne na info@memoai.eu
...
Za zahteve poslate **nakon isteka 5 kalendarskih dana** od zaduženja nema povraćaja.
...
Memo AI je internet usluga dostupna na memoai.eu (u nastavku „Memo AI”, „mi” ili „nas”).
