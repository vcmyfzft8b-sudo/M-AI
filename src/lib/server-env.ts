...
const serverEnvSchema = z.object({
  ...
  GEMINI_NOTES_MODEL: z.string().default("gemini-2.5-flash-lite"),
  ...
  NOTE_GENERATION_MODE: z.enum(["study_value", "strict_limits"]).default("study_value"),
...
export function getServerEnv() {
  return serverEnvSchema.parse({
    ...
    GEMINI_NOTES_MODEL: cleanEnvString(process.env.GEMINI_NOTES_MODEL),
    ...
    NOTE_GENERATION_MODE: cleanEnvString(process.env.NOTE_GENERATION_MODE),
